...
void TrackView::viewRiskMatrix(WContainerWidget* riskDetails) {
    ...
    auto dashboardContainer = riskDetails->addWidget(make_unique<WContainerWidget>());
   // viewTotalComplete(dashboardContainer);

   auto buttonContainer = dashboardContainer->addWidget(make_unique<WContainerWidget>());

   auto tableContainer = buttonContainer->addWidget(make_unique<WContainerWidget>());
   //box
  ...
  //Matriix
       ...
       auto matrixContainer = dashboardContainer->addWidget(make_unique<WContainerWidget>());
